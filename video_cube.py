#!/usr/bin/env python3
"""
video_cube.py — Headless Blender renderer for two cube streams.

Run:
    blender --background --python video_cube.py
...
class Settings:
    ...
    #input_dir       = "preprocessed/jumperbfpv"
    output_dir      = "renders/cubes_video"
    frame_prefix    = "frame"
...
def render_video_frames(input_dir, output_dir, stream1="cube1", stream2="cube2"):
    ...
    for out_i, fi in enumerate(selected):
        path = os.path.join(out_dir, f"{CFG.frame_prefix}_{out_i:05d}.png")
